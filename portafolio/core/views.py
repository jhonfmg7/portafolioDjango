...
def index(request):
    ...
    return render(request, 'core/index.html', {'images': images, 'tags': tags, 'instagram': instagram, 'services': services})
...
def about(request):
    ...
    return render(request, 'core/about.html', {'abilities': abilities, 'video': video, 'chooses': chooses, 'team': team, 'instagram': instagram, 'video_2': video_2})
...
def contact(request):
    ...
    return render(request, 'core/contact.html', {'contacts': contacts, 'form': contact_form,'instagram': instagram})
